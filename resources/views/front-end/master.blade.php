...
<head>
    ...
    <link href="{{asset('/frontend-assets')}}/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
    <!-- pop-up-box -->
    <link href="{{asset('/frontend-assets')}}/css/menu.css" rel="stylesheet" type="text/css" media="all" />
    <!-- menu style -->
    <!-- //Custom-Files -->
...
@yield('body')
@include('front-end.includes.middle-section')
...
<!-- scroll seller -->
<script src="{{asset('/frontend-assets')}}/js/scroll.js"></script>
<!-- //scroll seller -->
...
<script src="{{asset('/frontend-assets')}}/js/move-top.js"></script>
