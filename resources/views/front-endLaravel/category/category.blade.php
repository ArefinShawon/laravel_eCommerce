                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">
                                <div class="col-md-4 product-men">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Samsung Galaxy J7</a>
                                            </h4>
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/m2.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">OPPO A37f</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/m3.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Apple iPhone X</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            <div class="row">
                                <div class="col-md-4 product-men">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk1.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Infinix Hot S3</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk2.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Moto X4 (6 GB)</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk3.jpg" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">iVooMi i Series</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                            <div class="row">
                                <div class="col-md-4 product-men">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk4.jpg" alt="" class="img-fluid">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Dell Vostro Laptop</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk5.jpg" alt="" class="img-fluid">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Acer Laptop</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk6.jpg" alt="" class="img-fluid">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Lenovo </a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                                <span class="item_price">$300.00</span>
                                                <del>$320.00</del>
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mt-4">
                            <div class="row">
                                <div class="col-md-4 product-men">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk7.jpg" alt="" class="img-fluid">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Intex Power Bank</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk8.jpg" alt="" class="img-fluid">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">HP Wireless Printer</a>
                                            </h4>
                                            <div class="info-product-price my-2">
                                ...
                                <div class="col-md-4 product-men mt-md-0 mt-5 mt-5">
                                    <div class="men-pro-item simpleCart_shelfItem">
                                        <div class="men-thumb-item text-center">
                                            <img src="{{asset('/frontend-assets')}}/images/mk9.jpg" alt="" class="img-fluid">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('singleProduct_1')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                        ...
                                        <div class="item-info-product text-center border-top mt-4">
                                            <h4 class="pt-1">
                                                <a href="{{route('singleProduct_1')}}">Alcatel Tablet</a>
                                            </h4>
                                            <div class="info-product-price my-2">
